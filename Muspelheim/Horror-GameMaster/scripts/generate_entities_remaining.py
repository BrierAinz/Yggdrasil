...
ENTITY_TYPES = [
    ...
    ("shadow", "Shadow/darkness entities, shadows that move independently, void creatures with weight"),
    ...
    ("geometric", "Geometric/mathematical entities, impossible shapes, higher dimensions, fractal consciousness"),
    ("nature", "Nature/corruption entities, forests that think, animals behave as one, biological networks"),
    ("parasitic", "Parasitic entities that attach to hosts, feed on specific emotions, replace body parts"),
    ("recursive", "Recursive/loop entities, repetition patterns, creatures in the space between iterations"),
]
