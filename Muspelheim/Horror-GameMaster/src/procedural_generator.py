...
class GameEvent2(BaseModel):
    ...
    fear_type: str = ""
    follow_up_event: Optional[str] = None
...
class ProceduralGenerator:
    ...
    def generate_scene(self, scene_type: Optional[SceneType] = None) -> SceneTemplate:
    ...
    def _get_event_templates(self, event_type: EventType, fear_type: str) -> list[dict]:
        ...
        templates = {
            EventType.FORESHADOWING: [
                {"description": "A distant sound echoes through the walls", "narrative": "You hear something — not close, but not far enough. A sound that does not belong."},
                {"description": "An object has been moved since you last saw it", "narrative": "The chair is not where you left it. It has moved three feet to the left. It is facing the wall."},
                {"description": "A shadow passes across the doorway", "narrative": "Something crosses the doorway. Not a person — a shape, too fast, too dark, too wrong."},
                {"description": "A note appears where there was none before", "narrative": "The note is written in handwriting that is almost yours. It says: 'DO NOT TRUST THE NEXT ROOM.'"},
            ],
            EventType.RED_HERRING: [
                {"description": "A door rattles violently but nothing is behind it", "narrative": "The door shakes in its frame. You open it. Nothing. Wind? There is no wind."},
                {"description": "A figure appears to be hiding but turns out to be a coat rack", "narrative": "The shape in the corner is a person. No — a coat rack. It was always a coat rack. Wasn't it?"},
                {"description": "A loud crash comes from a room that is empty", "narrative": "The crash is massive — glass breaking, metal bending. You rush in. The room is pristine."},
            ],
            EventType.ESCALATION: [
                {"description": "The temperature drops sharply", "narrative": "The cold arrives suddenly, as if someone opened a door to winter. Your breath fogs. The walls begin to frost."},
                {"description": "Lights begin to fail one by one", "narrative": "The lights go out in sequence, each one dying with a pop. The darkness advances like a tide."},
                {"description": "Something that was hidden becomes visible", "narrative": "The wall was smooth. Now it has cracks. The cracks form a pattern. The pattern is a face."},
                {"description": "The architecture changes subtly", "narrative": "The hallway is longer than it was. The ceiling is lower. The doors are closer together. The building is compressing."},
            ],
            EventType.JUMPSCARE: [
                {"description": "Something drops from above", "narrative": "It falls from the ceiling — not fast, not slow, but deliberate. It lands in front of you. It is looking up."},
                {"description": "A face appears in the window", "narrative": "The face presses against the glass from outside. It is your face. It is smiling. You are not smiling."},
                {"description": "A hand grabs from below", "narrative": "The hand comes through the floor — through solid concrete — and grabs your ankle. It pulls."},
                {"description": "Everything goes silent, then: a scream", "narrative": "The silence is absolute. No heartbeat. No breathing. No ambient sound. Then the scream — from everywhere."},
            ],
            EventType.REVELATION: [
                {"description": "Evidence that the player is not who they think", "narrative": "The documents are clear. The name is yours. The photo is yours. The date of death is last year."},
                {"description": "The true nature of the location is revealed", "narrative": "This is not a building. It has never been a building. It is alive, and you are inside it."},
                {"description": "An NPC reveals they are not human", "narrative": "She stops talking. Her mouth closes. But the voice continues. It comes from behind her face."},
            ],
            EventType.ENVIRONMENTAL: [
                {"description": "Water begins to rise from the floor", "narrative": "The water is cold. Ankle-deep and rising. It smells like the ocean, but you are nowhere near the ocean."},
                {"description": "The walls begin to close in", "narrative": "The walls are closer. Not your imagination — the gap between them has decreased by six inches."},
                {"description": "A strange sound fills the space", "narrative": "The sound is not mechanical, not organic. It is the sound of something learning how to breathe."},
                {"description": "Gravity shifts subtly", "narrative": "The glass on the table slides. Slowly, deliberately, toward the wall. Gravity has changed direction."},
            ],
            EventType.ENTITY_SIGHTING: [
                {"description": "A figure stands at the end of the corridor", "narrative": "It stands at the far end. Motionless. Watching. It has been there since you arrived. You only just noticed."},
                {"description": "Something moves in peripheral vision", "narrative": "Every time you turn your head, it moves to the edge of your vision. You cannot look directly at it."},
                {"description": "A reflection shows something that is not there", "narrative": "The mirror shows the room correctly, except for the figure standing behind you. There is no one behind you."},
            ],
            EventType.SOUND_EVENT: [
                {"description": "Footsteps follow the player", "narrative": "The footsteps match yours — same pace, same rhythm — but they are one step behind. When you stop, they take one more."},
                {"description": "Whispering from the walls", "narrative": "The whispers are in a language you do not understand. But the tone is clear: it is discussing you."},
                {"description": "A child's laughter echoes", "narrative": "The laughter comes from upstairs. From a room you have not entered. From a room that should not have a child in it."},
            ],
            EventType.ITEM_DISCOVERY: [
                {"description": "A key hidden in an unexpected place", "narrative": "The key is inside the wall. You found it because the plaster was fresh — someone hid it recently."},
                {"description": "A photograph that should not exist", "narrative": "The photo shows you, in this room, taken from the corner. Taken today. You were alone."},
                {"description": "A journal with entries in your handwriting", "narrative": "The journal is full. Every page is in your handwriting. Every entry describes a day you do not remember."},
            ],
            EventType.NPC_ENCOUNTER: [
                {"description": "A person who should not be here", "narrative": "She says she has been here for weeks. She says the building will not let her leave. She says you cannot leave either."},
                {"description": "A voice on the radio", "narrative": "The radio crackles. A voice says your name. It says: 'Do not open the door.' The radio has no batteries."},
                {"description": "A child asking for help", "narrative": "The child is lost. The child is scared. The child's skin is cold. The child's eyes do not blink."},
            ],
            EventType.FALSE_SAFETY: [
                {"description": "A room that seems perfectly safe", "narrative": "The room is warm, lit, furnished. The door locks. The windows are intact. Nothing is wrong. Nothing. Yet."},
                {"description": "Contact from the outside world", "narrative": "The phone rings. A voice says rescue is coming. The voice is yours."},
                {"description": "A familiar object in a strange place", "narrative": "Your coffee mug. Your exact mug, with the chip on the handle. Here. In this impossible place."},
            ],
            EventType.TRAP: [
                {"description": "A door that locks behind the player", "narrative": "The door closes. The lock engages. Not a click — a thud. The sound of something heavy sealing shut."},
                {"description": "The floor gives way", "narrative": "The floor was solid. Now it is not. You fall — not far, but enough. The opening above you closes."},
                {"description": "An exit that leads back inside", "narrative": "You walk through the door and you are in the same room. The same room. The door behind you is gone."},
            ],
        }
        return templates.get(event_type, [{"description": "Something happens", "narrative": "Something happens."}])

    def _default_event(self, event_type: EventType) -> dict:
        return {"description": f"A {event_type.value} event occurs", "narrative": "Something happens."}
    ...
    def advance_chain(self, chain: ChainEvent) -> Optional[GameEvent2]:
    ...
    def degrade_safe_room(self, room: SafeRoom) -> Optional[str]:
        ...
        if room.safety_level <= 0.0:
            ...
            return room.compromise_event or "The safe room is no longer safe. Something has changed. The room that protected you has turned against you."
    ...
    def generate_entity_encounter(self, fear_type: str) -> EntitySpawn:
        ...
        templates = {
            "psychological": [
                ("The Watcher", "A figure that stands at the edge of your vision, always facing away", EntityBehavior.WATCHING),
                ("The Mimic", "Something that copies the faces of people you know, but wrong", EntityBehavior.MIMICKING),
                ("The Whisperer", "A voice that comes from inside the walls, speaking your thoughts", EntityBehavior.WHISPERING),
            ],
            "body_horror": [
                ("The Crawler", "A mass of limbs that moves like a spider made of human arms", EntityBehavior.STALKING),
                ("The Bloom", "A growth that spreads across surfaces, pulsing with a heartbeat", EntityBehavior.CORRUPTING),
                ("The Assembler", "Something that collects body parts and arranges them into patterns", EntityBehavior.AMBUSHING),
            ],
            "darkness": [
                ("The Absence", "A patch of darkness that is darker than the dark around it", EntityBehavior.PHASING),
                ("The Depth", "Something that lives in the space between light and shadow", EntityBehavior.STALKING),
                ("The Void", "An area where light goes to die, and something lives in the dead light", EntityBehavior.CORRUPTING),
            ],
            "paranoia": [
                ("The Observer", "Someone who has been watching you for longer than you have been here", EntityBehavior.WATCHING),
                ("The Replacement", "Something that is learning to be you, one detail at a time", EntityBehavior.MIMICKING),
                ("The Architect", "The thing that built this place, and knows every wall is a cage", EntityBehavior.CORRUPTING),
            ],
            "isolation": [
                ("The Echo", "Your own voice, coming back wrong, from places you did not speak", EntityBehavior.WHISPERING),
                ("The Distance", "Something that exists in the space between you and the nearest person", EntityBehavior.STALKING),
                ("The Last", "The thing that was here before you, and will be here after", EntityBehavior.WATCHING),
            ],
            "loss_of_control": [
                ("The Puppeteer", "Something that moves your body when you are not paying attention", EntityBehavior.CORRUPTING),
                ("The Director", "The entity that writes the script of your life, and you are reading it", EntityBehavior.WATCHING),
                ("The Loop", "A thing that exists in the repetition, growing stronger with each cycle", EntityBehavior.AMBUSHING),
            ],
            "jumpscare": [
                ("The Lurker", "Something that waits in the space you just checked, behind you", EntityBehavior.AMBUSHING),
                ("The Drop", "A thing that falls from above, but only when you look up", EntityBehavior.AMBUSHING),
                ("The Face", "Something that appears in windows, mirrors, and the dark", EntityBehavior.MANIFESTING),
            ],
        }
    ...
    def _build_templates(self) -> dict[SceneType, SceneTemplate]:
        ...
        templates[SceneType.ABANDONED_HOSPITAL] = SceneTemplate(
            ...
            potential_events=[EventType.ENTITY_SIGHTING, EventType.SOUND_EVENT, EventType.ESCALATION, EventType.FORESHADOWING],
            ambient_details=["Empty wheelchairs", "Medical records scattered on the floor", "An IV stand with a full bag, dripping", "A wheelchair at the end of the corridor, facing you"],
            danger_level=0.7,
        ...
        templates[SceneType.DARK_FOREST] = SceneTemplate(
            ...
            potential_events=[EventType.ENTITY_SIGHTING, EventType.ENVIRONMENTAL, EventType.ESCALATION, EventType.TRAP],
            ambient_details=["Trees that seem closer than before", "A path that leads back to where you started", "Eyes reflecting in the darkness", "A clearing with a circle of stones"],
            danger_level=0.6,
        ...
        templates[SceneType.MIRROR_MAZE] = SceneTemplate(
            ...
            potential_events=[EventType.JUMPSCARE, EventType.REVELATION, EventType.ENTITY_SIGHTING, EventType.ESCALATION],
            ambient_details=["A reflection that moves independently", "A mirror that shows a different room", "Glass that is warm to the touch", "A reflection with too many eyes"],
            danger_level=0.8,
        ...
        templates[SceneType.INFINITE_LIBRARY] = SceneTemplate(
            ...
            potential_events=[EventType.REVELATION, EventType.ENTITY_SIGHTING, EventType.FORESHADOWING, EventType.ITEM_DISCOVERY],
            ambient_details=["A book that writes itself", "Shelves that rearrange", "A reading nook with a warm cup of tea", "A book that contains your memories"],
            danger_level=0.6,
        ...
        templates[SceneType.MORGUE] = SceneTemplate(
            ...
            potential_events=[EventType.JUMPSCARE, EventType.REVELATION, EventType.ENTITY_SIGHTING, EventType.ESCALATION],
            ambient_details=["A drawer that opens on its own", "Toe tags with your name", "A body that was not there a moment ago", "The refrigeration stops"],
            danger_level=0.9,
        ...
        for st in SceneType:
            if st not in templates:
                templates[st] = SceneTemplate(
                    ...
                    sensory=SensoryDetail(sound="Unsettling ambient sounds", smell="Something wrong", temperature="Uncomfortable", light_level="Insufficient"),
                    danger_level=0.5,
