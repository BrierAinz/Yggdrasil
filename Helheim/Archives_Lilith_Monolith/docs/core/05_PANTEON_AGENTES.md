...
### 5.8.2 Cambio reciente (v4.2 - 2026-03-23)

**Antes:** Crystal usaba OpenRouter como backend (proxy a Haiku/Mini).
**Ahora:** Crystal usa la API de Kimi directamente (`kimi-for-coding`).

**Motivación:**
- Menor latencia (sin proxy intermedio)
- Mayor control sobre el modelo
- Consistencia con Lilith (mismo backend)
- Menor complejidad de infraestructura

**Fallback:** Si Kimi falla, usa Ollama local (`llama3.2:latest`).

### 5.8.3 Comportamiento
...
- Usa API key dedicada: `CRYSTAL_KIMI_API_KEY`
