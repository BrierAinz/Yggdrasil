...
sidebar_position: 4
title: Lilith v4.0
description: "Lilith v4.0: dark-fantasy CLI agent with hybrid memory and swarm intelligence"
---

# Lilith v4.0

A **dark-fantasy CLI agent** that runs entirely on your hardware. Hybrid memory, swarm intelligence, MCP protocol, multi-provider LLM, skills with hot-reload, and real-time dashboard. No cloud lock-in. No subscription. Control your PC from Telegram or the terminal.
...
- **330+ tests** passing — Core, Memory, Swarm, MCP, Dashboard, TOML Config, E2E.

:::

## How it works

Lilith v4.0 is organized in Six Realinos — each a module with its own law, all nourished by the same roots. The Orchestrator coordinates Skills, Memory, LLM Providers, Swarm, MCP, and Tools through a unified TOML configuration.
...
| GPU | — | NVIDIA 4GB+ VRAM | NVIDIA RTX 3060 4GB |
