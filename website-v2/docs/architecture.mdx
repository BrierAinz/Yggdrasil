...
A complete map of the Yggdrasil ecosystem — from the Nine Realms directory structure to the REST Gateway, every component that makes Lilith v4.0 work, including Multi-Provider LLM, Swarm Intelligence, MCP, Skills, and the real-time Dashboard.
