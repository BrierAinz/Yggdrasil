...
### 2.3 Regla sobre Legacy (IMPORTANTE)

**Legacy/ es conocimiento histórico y NO debe modificarse.**

- **NO** editar documentos dentro de `Legacy/`
- **NO** mover documentos a `Legacy/`
- **NO** actualizar, renombrar ni eliminar archivos en `Legacy/`
- **NO** crear nuevas carpetas dentro de `Legacy/`

**La única excepción:** Crear índices de referencia que apunten a documentos Legacy sin modificarlos.

**Ubicaciones para documentación nueva:**
- Documentación técnica actual: `Lilith/Core/Docs/` (fuera de Legacy)
- Misiones: `Lilith/Core/Docs/Misiones/`
- Documentación de proyectos: `Yggdrasil/Reino/Proyecto/README.md`
