...
- `Core/Backend/llm/openrouter_client.py`
- `Discord/groups/crystal_commands.py`
- `Discord/bot.py` (registro de comandos Crystal)

### Qué se construyó

- Agente **Crystal** con personalidad propia para público.
- Cliente OpenRouter dedicado para Crystal.
- Cascada de respuesta de Crystal:
  1) OpenRouter  
...
- `OPENROUTER_API_KEY` (para Crystal remoto)
