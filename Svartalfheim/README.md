...
```
Svartalfheim/
├── Docs/                                  # Documentación general + skills del ecosistema.
│   └── skills/                            #   Skill definitions (research, creative, comfyui, etc.)
├── Knowledge_Base/
...
├── LILITH_IDENTITY.md                     # Identidad visual y narrativa de Lilith.
├── LILITH_ARTIST_BRIEF.md                 # Brief para generación de arte de Lilith.
└── REGLAS.md                              # Reglas del reino.
```

## ⚔️ Estado

**Activo** — Repositorio central de conocimiento y tooling. Los enanos trabajan sin descanso.

## 🔗 Vínculos

- [Docs & Skills](./Docs/) — Documentación y definiciones de skills.
